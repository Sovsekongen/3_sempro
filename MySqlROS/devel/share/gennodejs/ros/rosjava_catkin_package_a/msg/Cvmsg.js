...
class Cvmsg {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float32(obj.exeTime, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.exeTime = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'rosjava_catkin_package_a/Cvmsg';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '3a0d5b8744bf7210b3fb7f726b3cf141';
  }
