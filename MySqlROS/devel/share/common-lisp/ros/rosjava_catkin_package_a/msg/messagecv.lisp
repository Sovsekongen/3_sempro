...
;//! \htmlinclude messagecv.msg.html

(cl:defclass <messagecv> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass messagecv (<messagecv>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <messagecv>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'messagecv)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosjava_catkin_package_a-msg:<messagecv> is deprecated: use rosjava_catkin_package_a-msg:messagecv instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <messagecv>))
...
(cl:defmethod pose-val ((m <messagecv>))
...
(cl:defmethod color-val ((m <messagecv>))
...
(cl:defmethod shape-val ((m <messagecv>))
...
(cl:defmethod pic-val ((m <messagecv>))
...
(cl:defmethod radius-val ((m <messagecv>))
...
(cl:defmethod exeTime-val ((m <messagecv>))
  ...
  (exeTime m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <messagecv>) ostream)
  "Serializes a message object of type '<messagecv>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <messagecv>) istream)
  "Deserializes a message object of type '<messagecv>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<messagecv>)))
  "Returns string type for a message object of type '<messagecv>"
  "rosjava_catkin_package_a/messagecv")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'messagecv)))
  "Returns string type for a message object of type 'messagecv"
  "rosjava_catkin_package_a/messagecv")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<messagecv>)))
  "Returns md5sum for a message object of type '<messagecv>"
  "76c45fb61e7f729ef565aaafd3f52a41")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'messagecv)))
  "Returns md5sum for a message object of type 'messagecv"
  "76c45fb61e7f729ef565aaafd3f52a41")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<messagecv>)))
  "Returns full string definition for message of type '<messagecv>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'messagecv)))
  "Returns full string definition for message of type 'messagecv"
  (cl:format cl:nil "Header header~%geometry_msgs/Pose pose~%string color~%string shape~%string pic~%uint32 radius~%uint32 exeTime~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <messagecv>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <messagecv>))
